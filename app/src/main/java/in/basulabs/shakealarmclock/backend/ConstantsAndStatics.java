...
public final class ConstantsAndStatics {
	 ...
	 * set by the user.
	 */
	public static final String BUNDLE_KEY_ALARM_DETAILS = "in.basulabs.shakealarmclock.ALARM_DETAILS_BUNDLE";
	 ...
	 */
	public static final String BUNDLE_KEY_ALARM_MINUTE = "in.basulabs.shakealarmclock.ALARM_MINUTES";
	 ...
	 */
	public static final String BUNDLE_KEY_ALARM_MESSAGE = "in.basulabs.shakealarmclock.ALARM_MESSAGE";

	/**
	 * Bundle key for Uri of the alarm tone.
	 */
	public static final String BUNDLE_KEY_ALARM_TONE_URI = "in.basulabs.shakealarmclock.ALARM_TONE_URI";

	/**
	 * Bundle key: Indicates whether the user has explicitly chosen a date for that
	 * alarm.
	 */
	public static final String BUNDLE_KEY_HAS_USER_CHOSEN_DATE = "in.basulabs.shakealarmclock.HAS_USER_CHOSEN_DATE";
	 ...
	 */
	public static final String SHARED_PREF_FILE_NAME = "in.basulabs.shakealarmclock.SHARED_PREF_FILE";
	 ...
	 * of an old alarm.
	 */
	public static final String ACTION_EXISTING_ALARM = "in.basulabs.shakealarmclock.ACTION_EXISTING_ALARM";
	 ...
	 */
	public static final String ACTION_NEW_ALARM_FROM_INTENT = "in.basulabs.shakealarmclock.ACTION_NEW_ALARM_FROM_INTENT";
	 ...
	 */
	public static final String EXTRA_PLAY_RINGTONE = "in.basulabs.shakealarmclock.EXTRA_PLAY_RINGTONE";
	 ...
	 */
	public static final String BUNDLE_KEY_OLD_ALARM_HOUR = "in.basulabs.shakealarmclock.OLD_ALARM_HOUR";
	 ...
	 */
	public static final String BUNDLE_KEY_OLD_ALARM_MINUTE = "in.basulabs.shakealarmclock.OLD_ALARM_MINUTE";
	 ...
	 */
	public static final String ACTION_DESTROY_RING_ALARM_ACTIVITY = "in.basulabs.shakealarmclock.DESTROY_RING_ALARM_ACTIVITY";

	/**
	 * {@link android.content.SharedPreferences} key to store the default shake
	 * operation.
	 * Can be either {@link #DISMISS} or SNOOZE.
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_SHAKE_OPERATION = "in.basulabs.shakealarmclock.DEFAULT_SHAKE_OPERATION";

	/**
	 * {@link android.content.SharedPreferences} key to store the default power button
	 * operation. Can be either {@link #DISMISS} or SNOOZE.
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_POWER_BTN_OPERATION = "in.basulabs.shakealarmclock.DEFAULT_POWER_BTN_OPERATION";
	 ...
	 */
	public static final String SHARED_PREF_KEY_SHAKE_SENSITIVITY = "in.basulabs.shakealarmclock.SHAKE_SENSITIVITY";
	 ...
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_ALARM_TONE_URI = "in.basulabs.shakealarmclock.DEFAULT_ALARM_TONE_URI";

	/**
	 * {@link android.content.SharedPreferences} key to store the default alarm volume.
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_ALARM_VOLUME = "in.basulabs.shakealarmclock.DEFAULT_ALARM_VOLUME";
	 ...
	 * {@code boolean}.
	 */
	public static final String SHARED_PREF_KEY_AUTO_SET_TONE = "in.basulabs.shakealarmclock.AUTO_SET_TONE";
