...
public class AlarmData {
	 ...
	 *
	 * @param isActive Whether alarm is switched on.
	 ...
	 */
	public AlarmData(boolean isActive, @NonNull LocalDateTime alarmDateTime, int alarmType, @Nullable String alarmMessage) {
	 ...
	 * @param alarmMessage The alarm message. May be {@code null}.
	 */
	public AlarmData(boolean isActive, @NonNull LocalTime alarmTime, int alarmType, @Nullable String alarmMessage, @NonNull ArrayList<Integer> repeatDays) {
		this.isActive = isActive;
	 ...
	 *
	 * @param active Pass {@code true} if the alarm is on, otherwise {@code false}.
	 */
	public void setSwitchedOn(boolean active) {
		isActive = active;
	}
