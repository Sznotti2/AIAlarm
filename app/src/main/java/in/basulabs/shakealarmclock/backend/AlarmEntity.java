...
public class AlarmEntity {
	...
	public AlarmEntity(int alarmHour, int alarmMinutes, boolean isAlarmOn, int alarmVolume, boolean isRepeatOn, int alarmType, int alarmDay,
					   int alarmMonth, int alarmYear, Uri alarmTone, String alarmMessage, boolean hasUserChosenDate) {
