...
public class Activity_AlarmDetails extends AppCompatActivity implements
		Fragment_AlarmDetails_Main.FragmentGUIListener,	AlertDialog_DiscardChanges.DialogListener {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			if (Objects.equals(getIntent().getAction(), ACTION_NEW_ALARM)) {
				...
				fragmentManager.beginTransaction().replace(R.id.addAlarmActFragHolder, new Fragment_AlarmDetails_Main())
	...
	private void setVariablesInViewModel() {
		...
		viewModel.setAlarmDateTime(LocalDateTime.now());
		...
		viewModel.setAlarmToneUri(alarmTone != null	?
				Uri.parse(alarmTone) : Settings.System.DEFAULT_ALARM_ALERT_URI);
	...
	private void setVariablesInViewModel(int mode, int alarmHour, int alarmMinute, int dayOfMonth, int month,
										 int year, boolean isRepeatOn, int alarmType, int alarmVolume,
